/*
 *  drivers/cpufreq/cpufreq_renice.c
 *
 *  Copyright (C)  2017 Sandeep Sethi
 *    
 *
 ...
 *                 2017 Sandeep Sethi <adeveloper79@gmail.com>
 *
...
#ifndef CONFIG_CPU_FREQ_DEFAULT_GOV_renice
static
#endif
struct cpufreq_governor cpufreq_gov_renice = {
	.name                   = "renice",
...
/* cpufreq_renice Governor Tunables */
...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	ret = cpufreq_register_governor(&cpufreq_gov_renice);
	if (ret)
		goto err_reg;
...
{
	cpufreq_unregister_governor(&cpufreq_gov_renice);
	kfree(&dbs_tuners_ins);
}

MODULE_AUTHOR("Sandeep Sethi <adeveloper79@gmail.com>");
MODULE_DESCRIPTION("'cpufreq_renice' - A dynamic balanced cpufreq governor");
MODULE_LICENSE("GPL");

#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_renice
